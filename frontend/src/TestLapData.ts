...
const ZANDVOORT_LAP_POINTS: TrackPoint[] = [
  { latitude: 52.38870, longitude: 4.54235, speed: 270, acc_x: 6, acc_y: 22, acc_z: 9.81, temperature: 65 },
  { latitude: 52.38965, longitude: 4.54345, speed: 305, acc_x: 8, acc_y: 18, acc_z: 9.81, temperature: 67 },
  { latitude: 52.39055, longitude: 4.54495, speed: 325, acc_x: 4, acc_y: 12, acc_z: 9.81, temperature: 68 },
  { latitude: 52.39115, longitude: 4.54695, speed: 300, acc_x: -10, acc_y: -20, acc_z: 9.81, temperature: 71 },
  { latitude: 52.39065, longitude: 4.54845, speed: 170, acc_x: -24, acc_y: -28, acc_z: 9.81, temperature: 78 },
  { latitude: 52.38945, longitude: 4.54915, speed: 145, acc_x: -31, acc_y: 8, acc_z: 9.81, temperature: 82 },
  { latitude: 52.38835, longitude: 4.54855, speed: 185, acc_x: -18, acc_y: 20, acc_z: 9.81, temperature: 80 },
  { latitude: 52.38745, longitude: 4.54725, speed: 235, acc_x: 12, acc_y: 24, acc_z: 9.81, temperature: 74 },
  { latitude: 52.38655, longitude: 4.54615, speed: 250, acc_x: 22, acc_y: 12, acc_z: 9.81, temperature: 72 },
  { latitude: 52.38555, longitude: 4.54545, speed: 285, acc_x: 14, acc_y: 18, acc_z: 9.81, temperature: 70 },
  { latitude: 52.38445, longitude: 4.54435, speed: 315, acc_x: 6, acc_y: 14, acc_z: 9.81, temperature: 68 },
  { latitude: 52.38365, longitude: 4.54285, speed: 330, acc_x: -8, acc_y: 12, acc_z: 9.81, temperature: 68 },
  { latitude: 52.38310, longitude: 4.54125, speed: 260, acc_x: -26, acc_y: -22, acc_z: 9.81, temperature: 77 },
  { latitude: 52.38345, longitude: 4.53995, speed: 155, acc_x: -33, acc_y: -12, acc_z: 9.81, temperature: 84 },
  { latitude: 52.38445, longitude: 4.53910, speed: 190, acc_x: -15, acc_y: 20, acc_z: 9.81, temperature: 80 },
  { latitude: 52.38560, longitude: 4.53875, speed: 245, acc_x: 18, acc_y: 21, acc_z: 9.81, temperature: 74 },
  { latitude: 52.38685, longitude: 4.53925, speed: 295, acc_x: 10, acc_y: 18, acc_z: 9.81, temperature: 70 },
  { latitude: 52.38795, longitude: 4.54035, speed: 340, acc_x: 4, acc_y: 15, acc_z: 9.81, temperature: 68 },
  { latitude: 52.38855, longitude: 4.54165, speed: 360, acc_x: 2, acc_y: 10, acc_z: 9.81, temperature: 66 },
  { latitude: 52.38870, longitude: 4.54235, speed: 370, acc_x: 0, acc_y: 8, acc_z: 9.81, temperature: 66 },
];

export class TestLapData {
  readonly points: TelemetryData[];

  constructor(points: TrackPoint[] = ZANDVOORT_LAP_POINTS) {
    this.points = points.map((point, index) => ({
      ...point,
      session_id: 1,
      timestamp: LAP_START_TIMESTAMP + Math.round((index / (points.length - 1)) * LAP_DURATION_MS),
    }));
  }
